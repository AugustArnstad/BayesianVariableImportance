...
d.morph <- readRDS("/Users/augustarnstad/Library/CloudStorage/OneDrive-NTNU/Semester_10/BayesianVariableImportance/data/d.morph.rds")

document()

# Save the dataset in the package with the new name
usethis::use_data(d.morph, overwrite = TRUE)
